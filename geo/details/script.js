...
if (title === "1+1 საშუალო ზომის პიცა") {
...
}else if(title === "2x ყველის პური + სოუსი"){
...
`
}else if(title === "2x ნივრის პური + სოუსი"){
